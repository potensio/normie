    ...
    <div className={className}>
      <ReactMarkdown
        ...
        components={{
          ...
          h4: ({ children, ...props }) => (
            <h4 className="text-base font-medium leading-tight mt-4 mb-2 text-zinc-900" {...props}>
              {children}
            </h4>
          ),
          h5: ({ children, ...props }) => (
            <h5 className="text-sm font-medium leading-tight mt-3 mb-2 text-zinc-900" {...props}>
              {children}
            </h5>
          ),
          h6: ({ children, ...props }) => (
            <h6 className="text-xs font-medium leading-tight mt-3 mb-2 text-zinc-500 uppercase tracking-wider" {...props}>
              {children}
            </h6>
          ),
          ...
          p: ({ children, ...props }) => (
            <p className="my-3 text-sm leading-[1.7] text-zinc-800 font-light" {...props}>
              {children}
            </p>
          ),
          ...
          li: ({ children, ...props }) => (
            <li className="text-sm leading-[1.7] text-zinc-800 marker:text-zinc-400 font-light" {...props}>
              {children}
            </li>
          ),
          ...
          code: ({ className, children, ...props }) => {
            ...
            return (
              <code
                className="px-1.5 py-0.5 text-[0.85em] font-mono rounded bg-zinc-100 text-zinc-800 border border-zinc-200"
                {...props}
              >
                {children}
              </code>
          ...
          blockquote: ({ children, ...props }) => (
            <blockquote
              className="my-3 pl-4 border-l-2 border-zinc-300 italic text-zinc-600"
              {...props}
            >
              {children}
            </blockquote>
          ...
          td: ({ children, ...props }) => (
            <td className="px-4 py-3 text-zinc-800 whitespace-nowrap" {...props}>
              {children}
            </td>
          ),
