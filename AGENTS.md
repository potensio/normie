...
**Tables:** `users`, `sessions`, `workspaces`, `workspace_files`, `workspace_members`, `workspace_skills`, `chats`, `messages`, `memories`, `daily_notes`, `user_api_keys`, `user_preferences`
